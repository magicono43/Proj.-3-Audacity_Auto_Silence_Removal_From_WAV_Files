...
VA_GetDevicePeriod(device_desc, ByRef default_period, ByRef minimum_period="") ;----------Still not sure how useful this one is to me, I don't really understand what the Period is measuring and what that means.
{
...
VA_SetDefaultEndpoint(device_desc, role) ;----Not Very Useful for my purposes it appears.
{
    /* Roles:
...
;
; IAudioMeterInformation : {C02216F6-8C67-4B5B-9D00-D008E73E0064} ;--------------These May be what I am looking for, just deeper down commands like this. "GetPeakValues"
;
